...
## <b> 3.1.1: Server Location </b>

Depending on where your tournament's region server location can be in various different places.

<b> Teams cannot force opponents to play on a server outside of the region that the tournament is hosted in. </b> Teams can agree to play on an alternative server location, but if both teams do not agree, the server's location will be defaulted to the tournament's original region.

<b> Default Locations: </b> <br />
NA: Chicago <br />
EU: Germany/Netherlands

## <b> 3.2: Servers need to be password protected </b>

All servers used for tournament matches must be password protected.

## <b> 3.3: Unusual server settings may be considered cheating </b>

The usage of servers with abnormal settings may be refused for matches by the league and/or be classified as cheating.

## <b> 3.4: Teams must be able to provide STV demos when requested </b>
